...
$(document).ready(function(){
  $("#new_happenin").on("click", function( event ) {
    ...
    myFirebaseRef.child("happenin").child(businessID).push({title: title, description: description, businessAddress: businessAddress, startTime: startTime, endTime: endTime})
  });
});
